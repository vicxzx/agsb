...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "xuege"         # 用户名
UUID = "cf4c3de7-ef6f-47a3-ad4a-043292f5d041"                     # UUID，留空则自动生成
PORT = 35799                   # Vmess端口，留空或0则自动生成
DOMAIN = "st1.zxz123.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiNTE4ZTMyNzU0NDY3MmNiMzRlZjNhZThkMmNhNzEzZjYiLCJ0IjoiNjE3ZDI4ODQtMjJlNC00OWIyLTg3ODYtNmYwZWJmODhkNjRlIiwicyI6IllUYzVNamN3T0RNdE1HSXlNeTAwWVRReUxXSTBNR1l0T0RRNU16SmpaR05oWTJNeSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
